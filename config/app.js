...
module.exports = {
  ...
  */
  ...
  api: {
	  key: "21fabf2223472e87f6b8661064bd32ead7740b4d5e6a8f6759441a2e52ebe73b0e72b8acc7343bfc6803e8b71c34a018",
	  uri: "https://api.wilde-oak.com/api/nextup/"
  },
  ...
  logger: {
    ...
    */
    ...
    file: {
      driver: 'file',
      name: Env.get('APP_NAME', 'adonis-app'),
      filename:  Env.get('LOG_FILENAME', 'adonis-%DATE%.log'),
      level: Env.get('LOG_LEVEL', 'debug'),
